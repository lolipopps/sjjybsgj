package com.sjjybsgj.common.login.controller;
...
import com.sjjybsgj.common.login.model.LoginModel;
...
public class LoginController extends BaseController {
	...
	public LoginModel signin(String username, String password, boolean remember) {
        ...
        LoginUser loginUser = delegateMapper.selectOne("com.sjjybsgj.common.login.mapper.LoginCustomMapper.getLoginUser", paramMap);
        ...
        List<Map<String, Object>> userRoles = delegateMapper.selectList("com.sjjybsgj.common.login.mapper.LoginCustomMapper.getUserRoles", loginUser.getUserId());
