...
### [English](https://github.com/micyo202/sjjybsgj/blob/master/README_EN.md) [中文文档](https://github.com/micyo202/sjjybsgj/blob/master/README.md)

<p align="center" >
  <img src="https://github.com/micyo202/sjjybsgj/raw/master/src/main/webapp/resources/images/logo.png" alt="Yan Demo" title="Yan Demo">
</p>

[![Beta](https://img.shields.io/badge/beta-0.2.6-brightgreen.svg)](https://github.com/micyo202/sjjybsgj)
[![Downloads](https://img.shields.io/badge/downloads-4.3MB-yellow.svg)](https://github.com/micyo202/sjjybsgj/archive/master.zip)
[![Since](https://img.shields.io/badge/since-2017-blue.svg)](https://github.com/micyo202/sjjybsgj)
[![License MIT](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://github.com/micyo202/sjjybsgj/blob/master/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/micyo202/sjjybsgj.svg?style=social&label=Stars)](https://github.com/micyo202/sjjybsgj)
[![GitHub forks](https://img.shields.io/github/forks/micyo202/sjjybsgj.svg?style=social&label=Fork)](https://github.com/micyo202/sjjybsgj)
...
|    ├── main -- 主模块路径
|    |    ├── java -- java类路径
|    |    |    ├── com.sjjybsgj.common -- 通用功能模块
|    |    |    ├── com.sjjybsgj.core -- 框架核心模块
|    |    |    ├── com.sjjybsgjdemo -- 业务模块
|    |    ├── resources -- 资源配置路径
|    |    |    ├── database -- 数据库sql文件
|    |    |    ├── mybatis -- mapper映射文件
|    |    |    ├── properties -- 配置文件
...
|    |    |    ├── views -- 视图路径
|    ├── test -- 测试模块路径
|    |    ├── com.sjjybsgjjunit -- 撰写单元测试类
```

## 四、项目结构（Construction）
> * com.sjjybsgj.common：通用功能模块（包含：用户登录、菜单、后台管理等...）
> * com.sjjybsgj.core：框架核心模块（包括基础的控制器、过滤器、拦截器、类加载器、注入器、注解、以及框架封装的核心方法部分）
> * com.sjjybsgjdemo：业务模块（根据实际项目名称换掉demo名称，所有业务模块均在该路径下）
> * com.sjjybsgj**.controller：控制器路径，存放自己编写业务处理的控制器（继承BaseController）
> * com.sjjybsgj**.mapper：持久层映射接口类路径（mbg生成mybatis对应的Mapper映射接口类）
> * com.sjjybsgj**.model：模型类路径（mbg生成的模型以及自定义模型）
> * com.sjjybsgjjunit：单元测试模块（便于撰写单元测试代码）
...
## 九、效果预览（Preview）
<img src="https://github.com/micyo202/sjjybsgj/raw/master/src/main/webapp/resources/images/login_preview.png" alt="login" title="login">
<img src="https://github.com/micyo202/sjjybsgj/raw/master/src/main/webapp/resources/images/web_preview.png" alt="web" title="web">
<img src="https://github.com/micyo202/sjjybsgj/raw/master/src/main/webapp/resources/images/mobile_preview.png" alt="mobile" title="mobile">

## 十、许可证（License）
[MIT License](https://github.com/micyo202/sjjybsgj/blob/master/LICENSE)
